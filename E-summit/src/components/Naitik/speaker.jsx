...
// --- 1. Data Integration (Your HTML Content mapped to the Design) ---
const allSpeakers = [
  {
    id: 1,
    name: "Ashneer Grover",
    role: "Founder, BharatPe",
    image: "assets/speakers/ashneer.png",
    color: "from-blue-500 to-cyan-400"
  },
  {
    id: 2,
    name: "Dr. Mohan Yadav",
    role: "CM, Madhya Pradesh",
    image: "assets/speakers/CM.png",
    color: "from-orange-500 to-yellow-400"
  },
  {
    id: 3,
    name: "Nitin Vijay",
    role: "Founder, Motion Edu",
    image: "assets/speakers/NV.png",
  ...
  },
  {
    ...
    name: "Anubhav Dubey",
    role: "Founder, CSB",
    image: "assets/speakers/Anubhav-dubey.png",
    color: "from-red-500 to-pink-500"
  },
  {
    id: 5,
    name: "Dr. Tanu Jain",
    role: "Civil Servant & Educator",
    image: "assets/speakers/Tanu-jain.png",
  ...
  },
  {
    ...
    image: "assets/speakers/abhishek.png",
  ...
  },
  {
    ...
    image: "assets/speakers/prafull.png",
  ...
  },
  {
    ...
    name: "Anubhav Sapra",
    role: "Food Blogger",
    image: "assets/speakers/anubhav-sapra.png",
  ...
  },
  {
    ...
    image: "assets/speakers/nidhi-narwal.png",
    color: "from-rose-400 to-pink-600"
  },
  {
    id: 11,
    name: "Gaurav Juyal",
    role: "Host, Art Attack",
    image: "assets/speakers/gaurav-juyal.png",
    color: "from-cyan-400 to-blue-500"
  },
  {
    id: 12,
    name: "Vanika Sangatani",
    role: "Writer & Speaker",
    image: "assets/speakers/vanshika.png",
...
const SpeakerCard = ({ speaker }) => (
  <div className="relative group w-[280px] h-[140px] shrink-0 mx-4 cursor-pointer">
    {/* Base Container */}
    <div className="absolute inset-0 bg-gaming-900 border border-white/10 rounded-lg overflow-hidden flex transition-all duration-300 group-hover:scale-105 group-hover:border-white/40 group-hover:shadow-[0_0_30px_rgba(0,0,0,0.5)] z-0 group-hover:z-20">
      ...
      <div className="w-2/5 h-full relative overflow-hidden">
        ...
        <div className={`absolute inset-0 bg-gradient-to-r ${speaker.color} mix-blend-overlay opacity-60 group-hover:opacity-0 transition-opacity`} />
      </div>

      {/* Text Half */}
      <div className="w-3/5 h-full bg-[#0a0a0a] p-4 flex flex-col justify-center border-l border-white/5 relative overflow-hidden">
        {/* Animated Background Line */}
...
// --- 3. The Marquee Component ---
const MarqueeRow = ({ items, direction = "left", speed = 30 }) => {
  return (
    <div className="flex overflow-hidden relative w-full py-4 group/track">
      <motion.div
        className="flex"
        animate={{ x: direction === "left" ? "-50%" : "0%" }}
        initial={{ x: direction === "left" ? "0%" : "-50%" }}
        ...
        style={{ width: "fit-content" }}
      >
        {/* Duplicate list 4 times to ensure infinite seamless loop */}
        {[...items, ...items, ...items, ...items].map((speaker, idx) => (
          <SpeakerCard key={`${speaker.id}-${idx}`} speaker={speaker} />
        ))}
      </motion.div>
...
const SpeakersSection = () => {
  return (
    <section className="relative w-full py-20 bg-gaming-950 overflow-hidden border-b border-white/5">
      ...
      {/* Background Tech Grid */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:64px_64px] pointer-events-none opacity-50" />
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-6 mb-12 text-center">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-xl md:text-2xl text-gray-400 font-medium mb-2 uppercase tracking-widest"
          >
            Speakers
          </motion.h2>
          ...
          <motion.h3
            ...
            viewport={{ once: true }}
            className="text-4xl md:text-6xl font-heading font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#501619] via-brand-primary to-[#7F050B] drop-shadow-[0_0_15px_rgba(255,255,255,0.1)]"
          >
