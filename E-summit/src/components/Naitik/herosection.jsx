...
//       <div className="absolute -top-20 -left-20 w-96 h-96 bg-brand-primary/1 blur-[120px] rounded-full pointer-events-none" />
//       {/* Bottom Right Glow (Secondary Purple) */}
//       <div className="absolute -bottom-20 -right-20 w-96 h-96 bg-brand-secondary/1 blur-[120px] rounded-full pointer-events-none" />
...
const HeroSection = () => {
  ...
  return (
    ...
    <section className="relative w-full min-h-[90vh] flex items-center justify-center overflow-hidden px-6 lg:px-20 py-20 bg-gaming-950 border-b border-white/5">
