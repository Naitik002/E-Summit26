...
const CaseStudyTeam = () => {
  ...
  const team = [
    { name: "Organizer 1", role: "Event Lead", img: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&q=80&w=1000" },
    { name: "Organizer 2", role: "Tech Head", img: "https://images.unsplash.com/photo-1599566150163-29194dcaad36?auto=format&fit=crop&q=80&w=1000" },
    { name: "Organizer 3", role: "Logistics", img: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&q=80&w=1000" },
    { name: "Organizer 4", role: "Relations", img: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=1000" },
  ];
                   ...
                   <div className="relative bg-zinc-900/50 backdrop-blur-sm border-l-2 border-zinc-800 hover:border-purple-500 transition-all duration-300 h-full overflow-hidden">
                      ...
                      <div className="p-6">
                         ...
                         <div className="flex gap-4">
                            <a href="#" className="text-gray-500 hover:text-white hover:bg-blue-600/20 p-1.5 rounded-sm transition-all"><Linkedin size={16} /></a>
                            <a href="#" className="text-gray-500 hover:text-white hover:bg-purple-600/20 p-1.5 rounded-sm transition-all"><Mail size={16} /></a>
                            <a href="#" className="text-gray-500 hover:text-white hover:bg-pink-600/20 p-1.5 rounded-sm transition-all"><Instagram size={16} /></a>
                         </div>
                      </div>
