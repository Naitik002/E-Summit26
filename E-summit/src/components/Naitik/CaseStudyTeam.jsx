...
import { Linkedin, Mail, Instagram, Shield, Cpu, Phone } from 'lucide-react'; // Added Phone icon
  ...
  const team = [
    {
      ...
      img: "./teamCase/Sanskar Shrivastava.jpeg",
      ...
      phone: "tel:+917024107999" // Add real number here
    },
    {
      name: "Hiya Sanghvi",
      role: "Events Lead",
      img: "./teamCase/Hiya Sanghvi.webp",
      ...
      phone: "tel:+917000092259" // Add real number here
    },
    {
      name: "Mohammad Maasir",
      role: "Resource & Procurement Lead",
      img: "./team_images/Mohammad Maasir.webp",
      linkedin: "https://www.linkedin.com/in/maasir554",
      insta: "https://instagram.com/maasir554",
      mail: "mailto:maasir554@gmail.com",
      phone: "tel:+916268987937" // Add real number here
    },
    {
      name: "Snehal Terdalkar",
      role: "Events Secretary",
      img: "./team_images/Snehal Terdalkar.webp",
      ...
      phone: "tel:+919558485996" // Add real number here
    }
  ];
              ...
              <div className="relative bg-zinc-900/50 backdrop-blur-sm border-l-2 border-zinc-800 hover:border-purple-500 transition-all duration-300 h-full overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-4">
                    <a href={member.linkedin} className="text-gray-500 hover:text-white hover:bg-blue-600/20 p-1.5 rounded-sm transition-all">
                      <Linkedin size={16} />
                    </a>
                    <a href={member.mail} className="text-gray-500 hover:text-white hover:bg-purple-600/20 p-1.5 rounded-sm transition-all">
                      <Mail size={16} />
                    </a>
                    <a href={member.insta} className="text-gray-500 hover:text-white hover:bg-pink-600/20 p-1.5 rounded-sm transition-all">
                      <Instagram size={16} />
                    </a>
                    {/* Phone Number Icon */}
                    <a href={member.phone} className="text-gray-500 hover:text-white hover:bg-green-600/20 p-1.5 rounded-sm transition-all">
                      <Phone size={16} />
                    </a>
                  </div>
                </div>
