...
//                    className="h-24 bg-white border border-white/5 rounded-lg flex items-center justify-center p-4 hover:border-brand-secondary/50 hover:bg-gaming-800 transition-all duration-300 group relative overflow-hidden"
//                  >
