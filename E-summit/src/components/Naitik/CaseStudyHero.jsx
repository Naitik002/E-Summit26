...
const CaseStudyHero = () => {
  return (
    // UPDATED: Added py-20 for mobile spacing, lg:py-0 and lg:h-screen to maintain laptop vertical centering
    <section className="relative min-h-screen flex items-center justify-center px-4 md:px-6 overflow-hidden bg-[#000000] py-20 lg:py-0">
      ...
      {/* Ambient Glows - UPDATED: Scaled down for mobile */}
      <div className="absolute top-[-10%] right-[-5%] w-[300px] h-[300px] lg:w-[600px] lg:h-[600px] bg-purple-900/20 blur-[100px] lg:blur-[150px] rounded-full animate-pulse"></div>
      <div className="absolute bottom-[-10%] left-[-5%] w-[250px] h-[250px] lg:w-[500px] lg:h-[500px] bg-cyan-900/20 blur-[100px] lg:blur-[150px] rounded-full animate-pulse delay-1000"></div>


      {/* --- LAYER 2: CONTENT --- */}
      {/* UPDATED: Added flex-col-reverse for mobile (optional, but standard usually keeps text top. Kept grid for fidelity) */}
      <div className="max-w-7xl mx-auto relative z-20 w-full grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 items-center mt-0 lg:mt-10">
        ...
        <div className="lg:col-span-7 space-y-6 lg:space-y-8 text-center lg:text-left">
          ...
          >
            <div className="px-3 py-1 lg:px-4 border border-cyan-500/30 bg-cyan-950/10 backdrop-blur-md flex items-center gap-2 lg:gap-3 rounded-sm">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-cyan-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-cyan-500"></span>
              </span>
              <span className="text-cyan-400 font-mono text-[10px] lg:text-xs uppercase tracking-[0.2em]">System_Breach_Detected // v.2.0.4</span>
            </div>
            <div className="hidden lg:block h-[1px] w-20 bg-gradient-to-r from-cyan-500/50 to-transparent"></div>
          </motion.div>
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row flex-wrap gap-4 lg:gap-6 pt-4 justify-center lg:justify-start"
          >
            {/* Primary Button */}
